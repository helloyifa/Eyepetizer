package me.helloyifa.eyepetizer.activities;
...
import me.helloyifa.eyepetizer.R;
...
public class SplashActivity extends AppCompatActivity {
    ...
    TextView mTvEnglishIntro;

    @BindView(R.id.iv_icom_splash)
    ImageView mIvIco;
    ...
    private void initViews(){
       Typeface font = Typeface.createFromAsset(getAssets(),"fonts/Lobster-1.4.otf");
        if(font!=null){
            mTvEnglishName.setTypeface(font);
            mTvEnglishIntro.setTypeface(font);
        }
    ...
    private void setAnim(){
        ...
        mIvIco.startAnimation(animationSet);
    }
}
